        ...
        >
          ...
          <table>
            ...
            <tr v-for="(r,i) in selected.relations" :key="i">
              <td>
                <input v-model="r.entity.name" class="min-w-0 w-16">
              </td>
              <td>
                <input v-model="r.cardinality" class="min-w-0 w-16">
              </td>
              <td>
                <input v-model="r.role" class="min-w-0 w-16">
              </td>
              <td class="text-center">
                <input v-model="r.total" class="min-w-0" type="checkbox">
              </td>
              <td>
                <button
                  type="button"
                  class="btn danger xsmall min-w-0 self-center mt-1 -mb-1"
                  @click="selected.removeRelation(i)"
                >
                  <svg
                    fill="currentColor"
                    class="w-4 h-4"
...
export default class diagramView extends Vue {
  ...
  pendingRelation: Relation = {entity: {name: ""} as Entity}
  ...
  addRelation() {
    ...
    this.selected.addRelation(this.pendingRelation)
